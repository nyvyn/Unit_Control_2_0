local unit_control = require("script/unit_control")
...
local reinit_all_deployers = function()
  ...
  for k, surface in pairs (game.surfaces) do
    for k, entity in pairs (surface.find_entities_filtered{name = array}) do
      if entity.valid then
        machines[entity.unit_number] = entity
        check_deployer(entity)
      end
    end
  end
